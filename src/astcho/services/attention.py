...
class AttentionService:
    ...
    def __init__(self, bot_id: str, *, base_talk_probability: float = 0.1):
    ...
    def should_plan(
        ...
        *,
        ...
        direct = message.mentioned_bot or message.replied_to_bot
    ...
    def context(self, limit: int = 20) -> str:
        ...
        for message in list(self.messages)[-limit:]:
            role = "Astcho" if message.user_id == self.bot_id or message.is_bot else message.nickname
