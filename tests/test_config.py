...
def test_settings_parse_lists(monkeypatch, tmp_path: Path):
    values = {
        "ASTCHO_LLM_API_KEY": "test",
        "ASTCHO_LLM_BASE_URL": "https://example.invalid/v1",
        "ASTCHO_CHAT_MODEL": "chat",
        "ASTCHO_PLANNER_MODEL": "planner",
        "ASTCHO_ADMINS": "1, 2",
        "ASTCHO_ALLOWED_GROUPS": "9,10",
        "ASTCHO_DATA_DIR": str(tmp_path),
        "ASTCHO_SHORT_HISTORY_LIMIT": "0",
    }
